...
st.set_page_config(page_icon="📊", page_title="AutoInsights")
...
st.sidebar.title("AutoInsights: Automated Exploratory Data Analysis and Data Processing")
...
# st.title("Welcome to AutoInsights")
# st.write('<div class="tagline">Unleash the Power of Data with AutoInsights!</div>', unsafe_allow_html=True)
...
# Centered title
st.markdown('<div class="title">Welcome to AutoInsights</div>', unsafe_allow_html=True)

# Centered tagline
st.markdown('<div class="tagline">Unleash the Power of Data with AutoInsights!</div>', unsafe_allow_html=True)
...
if uploaded_file is None and selected!='Home' and not use_example_data:
    ...
    if selected=='Data Preprocessing':
        ...
        **Min-Max scaling** transforms your data to fall between 0 and 1. It's like squeezing data into a specific range. This makes it easier to compare data points that vary widely.'''
        ...
        # Select numeric column for handling outlier
